...
To recap, `head()` lets you take a quick look at the first part of a data-storing 
object. We can specify how many rows we'd like to see through the argument `n`. 

We will ask and answer some questions about the chcracters. Feel free to make a 
